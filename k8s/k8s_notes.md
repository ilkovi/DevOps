...
### get more infor of a recource

$ kubectl describe nodes node-1



### get info about daemonset and kube-proxy
...
- objects as raw JSON or YAML using the -o json or -o yaml flags,
- kubectl with Unix pipes (e.g., kubectl … | awk …). If you specify the --no-headers flag

======================================================================

Another common task is extracting specific fields from the object. kubectl uses
the JSONPath query language to select fields in the returned object.

$ kubectl get pods my-pod -o jsonpath --template={.status.podIP}


If you feel like making interactive edits, instead of editing a local file,
...
* what subnets are allocated for our pod networks
